...
import logging
from espn_config import OUT_RANKINGS
...
def write_data_dictionary(output_dir: Path = OUT_RANKINGS.parent) -> Path:
    ...
    COLUMNS = [
        ...
        ("orb_pct",        "Four Factors", "Offensive rebound percentage — share of available offensive rebounds captured.", "20 – 45%", "Pipeline", "Dean Oliver's #3 factor (weight: 20%). High orb_pct = second-chance points machine."),
        ...
        ("ftr",            "Four Factors", "Free Throw Rate — free throw attempts per field goal attempt. Measures ability to get to the line.", "15 – 50%", "Pipeline", "Dean Oliver's #4 factor (weight: 15%). High ftr + high ft_pct = free point machine."),
