        ...
        try:
            ...
            schedule = self._build_frame(
                ...
                mapping={
                    ...
                    "team_a_seed": np.nan,
                    "team_b_seed": np.nan,
                    "team_a_is_home": lambda d: (~_bool(d.get("is_neutral"))).astype(int),
                    "team_b_is_home": 0,
            ...
            matchup = self._build_frame(
                ...
                mapping={
                    ...
                    "home_edge_team_a": lambda d: np.where(_bool(d.get("is_neutral")), 0.0, 1.0),
